...
describe("pizza reducer", () => {
  ...
  describe("entities", () => {
    it("shoult set pizza entities on FETCH_PIZZA_SUCCESS", () => {
      const expected = {
        margherita: {
          id: "margherita",
          index: 0,
  ...
  describe("isFetching", () => {
    it("shoult set true on FETCH_PIZZA", () => {
      const expected = true;
    ...
    it("shoult set false on FETCH_PIZZA_SUCCESS", () => {
    ...
    it("shoult set false on FETCH_PIZZA_ERROR", () => {
      const expected = false;
